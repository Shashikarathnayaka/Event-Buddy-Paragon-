...
class _NavigationScreenState extends ConsumerState<NavigationScreen> {
  ...
  Future<void> _checkOrganizerStatus() async {
    ...
    debugPrint('🔍 NavigationScreen - Checking organizer status');
    ...
    try {
      ...
      debugPrint(' Organizer status checked:');
      debugPrint('   Document exists: ${orgDoc.exists}');
      debugPrint('   Is Organizer: $_isOrganizer');

      if (orgDoc.exists) {
        debugPrint('   Organizer data: ${orgDoc.data()}');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(' Building NavigationScreen:');
